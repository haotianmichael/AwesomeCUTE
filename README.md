...
](https://arxiv.org/abs/2603.02298)，笔者将其翻译成中文作为参考。为保证精确性，文中保留了大量必要的专业术语，翻译过程加上了笔者自己的理解，水平有限，如发现有问题的还望指出。pdf和latex版本见[Github](https://github.com/haotianmichael/AwesomeCUTE).
...
笔者以`CUTE`为核心收集并整理与稠密`tensor`表示与相关编译IR/DSL设计相关的论文和技术报告见如下列表：
* [Papers about CUTE]()